...
1. `schema.sql` — baseline application schema.
...
6. `p0_webhook_idempotency.sql` — canonical Stripe webhook ledger + retry-safe atomic claim function. This file now includes `claimed_at`, failed-event retry, and stale-processing reclaim behavior.
